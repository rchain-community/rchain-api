 ...
 * PrepareRequest
 */
export type  PrepareRequest = { deployer: string; timestamp: number; nameQty: number };
/**
 * RhoUnforg
 */
 ...
 * JustificationInfo
 */
export type  JustificationInfo = { validator?: string; latestBlockHash?: string };
/**
 * DeployRequest
 */
 ...
 * ExprMap
 */
export type  ExprMap = { ExprMap: { data: { [key: string]: ref } } };
/**
 * UnforgDeployer
 */
