...
declare class coop$rchain$casper$protocol$NoApprovedBlockAvailable
  implements coop$rchain$casper$protocol$INoApprovedBlockAvailable {
  constructor(
...
declare class coop$rchain$casper$protocol$BlockMessage
  implements coop$rchain$casper$protocol$IBlockMessage {
...
declare class coop$rchain$casper$protocol$BlockMetadataInternal
  implements coop$rchain$casper$protocol$IBlockMetadataInternal {
  constructor(
...
declare class coop$rchain$casper$protocol$Header
  implements coop$rchain$casper$protocol$IHeader {
...
declare interface coop$rchain$casper$protocol$IProcessedDeploy {
  ...
  cost?: IPCost | null;
  log?: coop$rchain$casper$protocol$IEvent[];
  errored?: boolean;
}

declare class coop$rchain$casper$protocol$ProcessedDeploy
  implements coop$rchain$casper$protocol$IProcessedDeploy {
...
declare class coop$rchain$casper$protocol$Body
  implements coop$rchain$casper$protocol$IBody {
...
declare class coop$rchain$casper$protocol$Justification
  implements coop$rchain$casper$protocol$IJustification {
...
declare class coop$rchain$casper$protocol$RChainState
  implements coop$rchain$casper$protocol$IRChainState {
...
declare class coop$rchain$casper$protocol$Event
  implements coop$rchain$casper$protocol$IEvent {
...
declare class coop$rchain$casper$protocol$ProduceEvent
  implements coop$rchain$casper$protocol$IProduceEvent {
...
declare class coop$rchain$casper$protocol$ConsumeEvent
  implements coop$rchain$casper$protocol$IConsumeEvent {
...
declare class coop$rchain$casper$protocol$CommEvent
  implements coop$rchain$casper$protocol$ICommEvent {
...
declare class coop$rchain$casper$protocol$Bond
  implements coop$rchain$casper$protocol$IBond {
...
declare export class Var implements IVar {
  ...
  static decode(reader: $protobuf.Reader | Uint8Array, length?: number): typeof Var;
  static decodeDelimited(reader: $protobuf.Reader | Uint8Array): typeof Var;
  static verify(message: {
    [k: string]: any
  }): string | null;
  static fromObject(object: {
...
declare class google$protobuf$Empty implements google$protobuf$IEmpty {
